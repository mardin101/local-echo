(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs'), require('rxjs/operators'), require('socket.io-client'), require('@angular/common'), require('@angular/common/http'), require('@angular/core')) :
  typeof define === 'function' && define.amd ? define(['exports', 'rxjs', 'rxjs/operators', 'socket.io-client', '@angular/common', '@angular/common/http', '@angular/core'], factory) :
  (factory((global.ngxLaravelEcho = {}),global.Rx,global.Rx.Observable.prototype,global.io,global.ng.common,global.ng.common.http,global.ng.core));
}(this, (function (exports,rxjs,operators,io$1,common,http,core) { 'use strict';
   ...
   * The token used to inject the config in Angular's DI system
    @type {?} */
  var ECHO_CONFIG = new core.InjectionToken('echo.config');
  /**
   * @hidden
   */
  var /**
  ...
  var EchoService = /** @class */ (function () {
      ...
      function EchoService(ngZone, config) {
          ...
          switch (options.broadcaster) {
              case 'null':
                  this.connectionState$ = rxjs.of({ type: 'connected' });
                  break;
              case 'socket.io':
                  this.connectionState$ = new rxjs.Observable(function (subscriber) {
                      /** @type {?} */
              ...
              case 'pusher':
                  ...
                  break;
              default:
                  this.connectionState$ = rxjs.throwError(new Error('unsupported'));
                  break;
          }
          this.connected$ = (/** @type {?} */ (this.connectionState$)).pipe(operators.map(function () { return _this.connected; }), operators.startWith(this.connected), operators.distinctUntilChanged(), operators.shareReplay(1));
      }
      ...
      function (name, event) {
          ...
          if (!channel.listeners[event]) {
              /** @type {?} */
              var listener_1 = new rxjs.Subject();
      ...
      function (name, event) {
          ...
          if (channel.type === 'public') {
              return rxjs.throwError(new Error('Whisper is not available on public channels'));
          }
          if (!channel.listeners["_whisper_" + event + "_"]) {
              /** @type {?} */
              var listener_2 = new rxjs.Subject();
      ...
      function (type, name) {
          ...
          if (name && name !== this.userChannelName) {
              ...
              if (!channel_1.notificationListeners[type]) {
                  channel_1.notificationListeners[type] = new rxjs.Subject();
              }
              return channel_1.notificationListeners[type].asObservable();
          }
          if (!this.notificationListeners[type]) {
              this.notificationListeners[type] = new rxjs.Subject();
          }
      ...
      function (name) {
          ...
          if (!channel.listeners["_joining_"]) {
              channel.listeners['_joining_'] = new rxjs.Subject();
          }
      ...
      function (name) {
          ...
          var channel = this.requireChannelFromArray(name, 'presence');
          if (!channel.listeners["_leaving_"]) {
              channel.listeners['_leaving_'] = new rxjs.Subject();
          }
      ...
      function (name) {
          ...
          var channel = this.requireChannelFromArray(name, 'presence');
          if (!channel.listeners["_users_"]) {
              channel.listeners['_users_'] = new rxjs.ReplaySubject(1);
          }
      ...
      EchoService.ctorParameters = function () { return [
          { type: core.NgZone },
          { type: undefined, decorators: [{ type: core.Inject, args: [ECHO_CONFIG,] }] }
      ]; };
      return EchoService;
  }());
  ...
  var NgxLaravelEchoModule = /** @class */ (function () {
      ...
      function (config) {
          return {
              ...
              providers: [
                  EchoService,
                  { provide: http.HTTP_INTERCEPTORS, useClass: EchoInterceptor, multi: true },
  ...
  exports.EchoInterceptor = EchoInterceptor;
  exports.NgxLaravelEchoModule = NgxLaravelEchoModule;
  exports.ECHO_CONFIG = ECHO_CONFIG;
